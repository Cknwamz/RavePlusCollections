/**
 * Order Confirmation Email (Serverless Function)
 * Uses Resend to send HTML emails to customer and admin.
 */
const { Resend } = require('resend');

// In production, this key is stored in your hosting dashboard (Vercel/Netlify)
